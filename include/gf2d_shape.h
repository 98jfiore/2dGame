...
* @return a GF2D rect
*/
Rectangle gf2d_rect(float x, float y, float w, float h);
...
*/
Shape gf2d_shape_from_rect(Rectangle r);
...
*/
Uint8 gf2d_point_in_rect(Vector2D p, Rectangle r);
...
*/
Uint8 gf2d_rect_overlap(Rectangle a, Rectangle b);
...
* @return true if there is any overlap, false otherwise
*/
Uint8 gf2d_rect_overlap_poc(Rectangle a, Rectangle b, Vector2D *poc, Vector2D *normal);
...
*/
void gf2d_rect_draw(Rectangle r, Color color);
...
* @return true if there is any overlap, false otherwise
*/
Uint8 gf2d_circle_rect_overlap(Circle a, Rectangle b);
...
* @return true if there is any overlap, false otherwise
*/
Uint8 gf2d_circle_rect_overlap_poc(Circle a, Rectangle b, Vector2D *poc, Vector2D * normal);
...
* @return an SDL rect
*/
SDL_Rect gf2d_rect_to_sdl_rect(Rectangle r);
...
* @return a GF2D rect
*/
Rectangle gf2d_rect_from_sdl_rect(SDL_Rect r);
...
/**
* @brief change the position of the shape to other vector
* @param shape a pointer to the shape to move
* @param move the amount to move the shape
*/
void gf2d_shape_move_to(Shape *shape, Vector2D move);
...
*/
Uint8 gf2d_edge_rect_intersection(Edge e, Rectangle r);
...
* @return true if there is an intersection, false otherwise
*/
Uint8 gf2d_edge_rect_intersection_poc(Edge e, Rectangle r, Vector2D *poc, Vector2D *normal);
...
void gf2d_rect_slog(Rectangle r);
